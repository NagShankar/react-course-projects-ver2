...
//        });
        ...
        //this issue can be fixed by using function as argument instead of passing the object, output will be 1, first it will be serest to zero, rught after that another setState gets executed which increment by 1, i.e it updated multiple setState asynchronously
